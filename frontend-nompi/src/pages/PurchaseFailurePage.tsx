...
export const PurchaseFailurePage: React.FC = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4">
      <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl border border-gray-200 p-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-gray-900">Compra fallida</h1>
            <p className="text-sm text-gray-600">No pudimos procesar tu pago.</p>
          </div>
        </div>

        <div className="mt-6 rounded-xl bg-gray-50 border border-gray-200 p-4">
          <p className="text-sm text-gray-700">
            Por favor intenta nuevamente o usa otra tarjeta.
          </p>
        </div>
